...
class Post_List extends Widget_Base
{
     ...
     */
    protected function get_last_modified_date($settings)
    {
     ...
     * @return void
     */
    public function render_post_meta_dates($settings)
    {
        ...
        $last_modified_date = $this->get_last_modified_date($settings);
